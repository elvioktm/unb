...
def monitorFiles( outfiles, seconds, timeoutms ):
    "Monitora o conjunto de arquivos e retorna [(host, line)...]"
    ...
    for h, outfile in outfiles.iteritems():
        ...
        fdToHost[ fd ] = h
    # Prepara para pesquisar os arquivos de saida
    readable = poll()
    for t in tails.values():
        readable.register( t.stdout.fileno(), POLLIN )
    # Executa ate que um numero definido de segundos tenha decorrido
    ...
    while time() < endTime:
        ...
        if fdlist:
            ...
            # Se o tempo acabar, nao retorna nada
            yield None, ''
    for t in tails.values():
        t.terminate()
    devnull.close()
